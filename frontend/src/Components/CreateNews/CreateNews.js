...
export const CreateNews = () => {
  ...
  return (
    <div className="flex flex-col h-screen md:flex-row justify-center ">
      <div className="flex flex-col h-5/6 max-h-full w-full md:w-1/2 bg-white rounded-lg border-2 border-blue-200 p-8 m-3 items-stretch justify-stretch gap-10 overflow-y-auto mt-0">
        <form
      ...
      {openModal && (
        <Modal size="xl" centered={true}>
          ...
          <ModalBody>
            ...
            ipsum quidem sapiente id maiores, quam animi cumque placeat, omnis
            nemo porro provident earum sunt. Quibusdam odio nam porro fugit?
          </ModalBody>
          <ModalFooter>
