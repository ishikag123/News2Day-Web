...
export const Dashboard = () => {
  return (
    <div className="flex w-full h-screen">
      <div className="flex flex-col w-3/5 rounded-r-3xl bg-[#86e5fa70] h-5/6 p-16 text-left gap-10 font-serif shadow-lg">
        ...
        <p className="text-lg text-gray-500">
          ...
          dolore commodi aspernatur reiciendis autem, non ut? Vero commodi natus
          officia dolorem? Lorem ipsum, dolor sit amet consectetur adipisicing
          elit. Eaque blanditiis odio similique fugiat laborum dignissimos,
          saepe provident recusandae incidunt unde sunt aliquid pariatur ut
          quisquam velit, minima, nobis beatae quibusdam?
        </p>
